Now that we have kicked off our Fuse application to build and deployment lets take a look at the logs from our build. First we can take a look at the output from the command line.
